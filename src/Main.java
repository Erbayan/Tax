...
public class Main {
    public static void main(String[] args) {
        ...
        TaxStrategyFactory factory = new PensionTaxStrategyFactory();
        TaxStrategy pensionTaxStrategy = factory.createTaxStrategy();
        factory = new SocialMedicalTaxStrategyFactory();
        TaxStrategy socialMedicalTaxStrategy = factory.createTaxStrategy();
        factory  = new SocialTaxStrategyFactory();
        ...
        OldTaxSystem oldPensionTaxStrategy = new OldPensionTaxStrategy();
        OldTaxSystem oldSocialMedicalTaxStrategy = new OldSocialMedicalTaxStrategy();
        OldTaxSystem oldSocialTaxStrategy = new OldSocialTaxStrategy();
